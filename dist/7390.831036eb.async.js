(self.webpackChunk=self.webpackChunk||[]).push([[7390],{99507:function(a,d,r){a=r.nmd(a),ace.define("ace/theme/nord_dark-css",["require","exports","module"],function(n,e,c){c.exports=`.ace-nord-dark .ace_gutter {
  color: #616e88;
}
...
`}),ace.define("ace/theme/nord_dark",["require","exports","module","ace/theme/nord_dark-css","ace/lib/dom"],function(n,e,c){e.isDark=!0,e.cssClass="ace-nord-dark",e.cssText=n("./nord_dark-css"),e.$selectionColorConflict=!0;var o=n("../lib/dom");o.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/nord_dark"],function(n){a&&(a.exports=n)})}()}}]);
