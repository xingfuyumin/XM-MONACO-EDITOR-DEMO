(self.webpackChunk=self.webpackChunk||[]).push([[9796],{39796:function(a,d,r){a=r.nmd(a),ace.define("ace/theme/one_dark-css",["require","exports","module"],function(n,e,c){c.exports=`.ace-one-dark .ace_gutter {
    background: #282c34;
    color: #6a6f7a
}
...
`}),ace.define("ace/theme/one_dark",["require","exports","module","ace/theme/one_dark-css","ace/lib/dom"],function(n,e,c){e.isDark=!0,e.cssClass="ace-one-dark",e.cssText=n("./one_dark-css");var o=n("../lib/dom");o.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/one_dark"],function(n){a&&(a.exports=n)})}()}}]);
